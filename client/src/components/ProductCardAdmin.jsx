  ...
  return (
    <div className='w-36 p-4 bg-white rounded'>
        ...
        <div className='grid grid-cols-2 gap-3 py-2'>
          <button onClick={()=>setEditOpen(true)} className='border px-1 py-1 text-sm border-pink-600 bg-pink-100 text-pink-800 hover:bg-pink-200 rounded'>Edit</button>
            ...
            <section className='fixed top-0 left-0 right-0 bottom-0 bg-neutral-600 z-50 bg-opacity-70 p-4 flex justify-center items-center '>
                <div className='bg-white p-4 w-full max-w-md rounded-md'>
                    ...
                    <div className='flex justify-end gap-5 py-4'>
                      ...
                      <button onClick={handleDelete} className='border px-3 py-1 rounded bg-pink-100 border-pink-500 text-pink-500 hover:bg-pink-200'>Delete</button>
                    </div>
                </div>
            </section>
          )
